...
training_data_loc='CryoEM_Training_Set/Train'										#string: location of training data directory
test_data_loc='CryoEM_Training_Set/Test'										#string: location of test data directory
